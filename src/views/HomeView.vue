        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              <h1 class="text-blue">Hellow,</h1>
              <h1 class="text-white">I'M Nadia Caroline</h1>
              <span class="text-blue">Web Designer & Developer</span><br />
          ...
          <v-col cols="5">
            <div style="position: relative; z-index: 9999" class="mt-16">
              <v-img src="j3.png" contain max-height="300"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="j2.png" max-height="300"></v-img>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
              ...
              <h4>And Developer</h4>
              <p class="text-black">Saya mahasiswa aktif semester 5 dengan jurusan teknik informatika yang kini tengah menjalani masa student independen kampus merdeka</p>
              <br />
              <p class="text-black">Saat ini sedang sibuk rebahan dan memikirkan masa depan dengan belajar dan belajar sambil memisuh</p>
              <v-btn tile-dark color="blue" class="mt-4"> Download Resume </v-btn>
            </v-col>
          </v-row>
        </div>
      </v-col>
          ...
          <v-row>
            <v-col cols="12">
              <div class="child">
                ...
                <p class="text-grey ml-3 mt-4 text-caption">Lorem, ipsum dolor sit amet <br />consectetur adipisicing <br />consectetur adipis</p>
              </div>
              <div class="child">
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              <span class="text-caption">00235 -6547</span><br />
              <v-btn icon="fas fa-phone-alt" class="mt-10" variant="outlined"></v-btn><br />
              <span class="text-caption">nanad@gmail.com</span><br />
              <span class="text-caption">nanad@gmail.com</span><br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
